...
def get_citation_args():
    ...
    parser.add_argument('--weight_decay', type=float, default=1e-2,
                        help='Weight decay (L2 loss on parameters).') # default: 5e-6
    ...
    parser.add_argument('--combine', type = str, default = 'max', help = 'combination method')
    parser.add_argument('--beta', type = float, default=0.1, help='beta')
    parser.add_argument('--delta', type = float, default=0.9, help='beta')
